...
// NB: This is a 1-to-1 logical copy of MiniscopeV4BNO055Device.
// I have not found a way to use e.g. type alias for this.
...
namespace Bonsai.ONIX
{
    ...
    [Description("Acquire data from Neuropixels 2.0e Headstage's BNO055 inertial measurement unit.")]
    public class NeuropixelsV2eBNO055Device : ONIDevice
    {
